  ...
  return {
    ...
    sessions: [
        ...
        workflows: [
          {
            ...
            status: 'completed',
            snapshotDurationMs: 184_000,
            snapshotAgentCount: 3,
            snapshotTotalTokens: 412_000,
            phases: [
              { title: 'Scope & plan', detail: 'Read spec, enumerate touched files' },
              { title: 'Implement', detail: 'Apply edits across 4 modules' },
              { title: 'Self-review', detail: 'Diff audit + clippy gate' },
            ],
            parsedAgentCount: 3,
            parsedTurns: 41,
            parsedOutputTokens: 21_400,
            parsedCost: 18.42,
          },
          {
            runId: 'wf_9a14bb02-118',
            workflowName: 'docs-sync',
            status: 'running',
            snapshotDurationMs: null,
            snapshotAgentCount: 1,
            snapshotTotalTokens: 58_000,
            phases: [
              { title: 'Collect changelog', detail: null },
              { title: 'Regenerate README', detail: null },
            ],
            parsedAgentCount: 1,
            parsedTurns: 6,
            parsedOutputTokens: 3_100,
            parsedCost: 1.97,
          },
        ],
        turns: [
      ...
      },
      {
        ...
        workflows: [
          {
            runId: 'wf_3f88c1d0-204',
            workflowName: null,
            status: 'failed',
            snapshotDurationMs: 76_500,
            snapshotAgentCount: 2,
            snapshotTotalTokens: null,
            phases: [],
            parsedAgentCount: 2,
            parsedTurns: 19,
            parsedOutputTokens: 9_800,
            parsedCost: 7.31,
          },
        ],
        turns: [
